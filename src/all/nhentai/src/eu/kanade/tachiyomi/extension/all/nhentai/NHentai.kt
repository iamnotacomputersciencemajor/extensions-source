...
open class NHentai(
    ...
    override fun popularMangaRequest(page: Int) = GET(if (nhLang.isBlank()) "$baseUrl/?sort=popular&page=$page" else "$baseUrl/language/$nhLang/?sort=popular&page=$page", headers)
